                    ...
                    CustomButton(
                      onTap: () async {
                          ...
                          )
                         {
                          ...
                          if( _password.text != _password_confirmation.text )
                          {
                            CustomAwesomeDialog(context, "Password and Confirm Password is not equal!", DialogType.error).show();
                            return;
                          }
                          ...
                          var user  = UserCreate(
                            ...
                            passwordConfirmation: _password_confirmation.text, 
                            name: _name.text);

                           //var loginModel = Login(email:_email.text ,password: _password.text);
